...
CHALLENGE_NAME = "Присідання"
CHALLENGE_DESCRIPTION = (
    "Завдання: зроби присідання <b>5 разів за тиждень</b>.\n\n"
    "Це можуть бути класичні присідання, присідання з вагою, присідання на одній нозі (пістоль), "
    "динамічні присідання або будь-які інші варіації.\n\n"
    "Кількість повторень не важлива — головне виконати присідання та скинути відео.\n\n"
    "✅ 1 виконання = <b>+50 HP</b>\n"
    "📅 Ліміт: <b>1 раз на день</b>\n"
    "🏆 Повний челендж: <b>5/5 = 250 HP</b>\n\n"
    "Прокачай ноги, дисципліну та витривалість.\n\n"
