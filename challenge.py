...
CHALLENGE_NAME = "Відтискання від підлоги"
CHALLENGE_DESCRIPTION = (
    "Завдання: зроби відтискання від підлоги <b>5 разів за тиждень</b>.\n\n"
    "Кількість повторень не важлива — головне виконати підхід і скинути відео.\n\n"
